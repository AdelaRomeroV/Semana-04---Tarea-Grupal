...
{
    internal class SubDesarrollado : Pais
    {
        public SubDesarrollado(string name, float poblacion, float dinero, float salud, float educacion, float seguridad, float felicidad, float gastos, float impuestos)
        {
