...
{
    internal class Desarrollado : Pais
    {
        public Desarrollado(string name, float poblacion, float dinero, float salud, float educacion, float seguridad, float felicidad, float gastos, float impuestos)
        {
